...
public class Frmbarang2 extends javax.swing.JDialog {
    ...
    public Frmbarang2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
  ...
  //              Logger.getLogger(FrmtransaksiKeluar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Frmbarang2 dialog = new Frmbarang2(new javax.swing.JFrame(), true);
            dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosing(java.awt.event.WindowEvent e) {
                    System.exit(0);
                    new Frmbarang2().setVisible(true);
                }
            });
