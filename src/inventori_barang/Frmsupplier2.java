...
public class Frmsupplier2 extends javax.swing.JDialog {
    ...
    public Frmsupplier2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tabelsupplier.id, tabelsupplier.kode, tabelsupplier.nama, tabelsupplier.no_telp, tabelsupplier.alamat FROM tabelsupplier");
    ...
    private void GetData_View(){
     ...
     private void cari(){
        try {
            Connection conn = konek.openkoneksi();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet sql = stm.executeQuery("select * from tabelsupplier where nama like '%"+txtcari.getText()+"%'");
            datatable.setModel(DbUtils.resultSetToTableModel(sql));
            datatable.getColumnModel().getColumn(0).setPreferredWidth(35);
            datatable.getColumnModel().getColumn(1).setPreferredWidth(70);
            datatable.getColumnModel().getColumn(2).setPreferredWidth(100);
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_supplier_64px.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblcount_rows, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(171, 171, 171)
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tabelsupplier.id, tabelsupplier.kode, tabelsupplier.nama, tabelsupplier.no_telp, tabelsupplier.alamat FROM tabelsupplier WHERE tabelsupplier.id='"+row_id+"'");
                if(sql.next()){
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(!"".equals(row_txtkode) && !"".equals(row_txtnama) && !"".equals(row_txttelp) && !"".equals(row_txtalamat)){
             try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tabelsupplier.id) as count FROM tabelsupplier WHERE tabelsupplier.kode='"+row_txtkode+"'");
                sql.next();
            ...
            if("".equals(row_id)){
                if(c_kode == 0)
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("INSERT INTO tabelsupplier(kode, nama, no_telp, alamat) VALUES ('" + row_txtkode + "', '" + row_txtnama + "', '" + row_txttelp + "', '" + row_txtalamat + "')");
                ...
                if(c_kode == 0 || row_txtkode.equals(row_txttemp_kode))
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tabelsupplier SET kode='" + row_txtkode + "',nama='" + row_txtnama + "',no_telp='" + row_txttelp + "',alamat='" + row_txtalamat + "' WHERE id = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tabelsupplier WHERE id = '" + row_id + "'");
...
this.dispose();
        new mainview2().setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Frmsupplier2 dialog = new Frmsupplier2(new javax.swing.JFrame(), true);
