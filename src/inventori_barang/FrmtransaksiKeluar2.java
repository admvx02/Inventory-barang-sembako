...
public class FrmtransaksiKeluar2 extends javax.swing.JDialog {
    ...
    public FrmtransaksiKeluar2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
    ...
    private void SelectPelanggan(){
        try {
            ...
            java.sql.ResultSet rs = stm.executeQuery("SELECT * FROM tabelpelanggan");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 613, -1, -1));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_transaction_approved_80px.png"))); // NOI18N
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 167, 970, 370));
        ...
        getContentPane().add(txttgl, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 111, 160, -1));
        ...
        getContentPane().add(txtnm_petugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 220, -1));
        ...
        getContentPane().add(btnsave, new org.netbeans.lib.awtextra.AbsoluteConstraints(765, 545, -1, 46));
        ...
        getContentPane().add(txtid_pelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 110, 22, -1));
        ...
        getContentPane().add(txtid_petugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 20, -1));
        ...
        getContentPane().add(cmbid_pelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 154, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 550, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 90, -1));
    ...
    private void cmbid_pelangganItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbid_pelangganItemStateChanged
        ...
        if(!kode.equals("Pilih")){
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT id FROM tabelpelanggan WHERE kode='"+kode+"'");
                if(sql.next()){
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(rowCount > 0 && !"".equals(row_tgl) && !"".equals(row_idpelanggan) && !"".equals(row_idpetugas)){
            ...
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("INSERT INTO tblbarang_keluar(tgl, id_petugas, id_pelanggan) VALUES ('" + row_tgl + "', '" + row_idpetugas + "', '" + row_idpelanggan + "')");
                konek.closekoneksi();
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error " + e);
            } catch (ClassNotFoundException ex) {
            ...
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT MAX(id) as max FROM tblbarang_keluar");
                sql.next();
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                if(not_found == 0){
                    ...
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("INSERT INTO tblbarang_keluar_detail(id_barang_keluar, id_barang, jumlah) VALUES ('" + id_barang_keluar + "', '" + id + "', '" + jumlah + "')");
                        empty = 1;
                        konek.closekoneksi();
                    } catch (SQLException e) {
                        JOptionPane.showMessageDialog(null, "Error " + e);
                ...
                if(empty == 0){
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("DELETE FROM tblbarang_keluar WHERE id = '" + id_barang_keluar + "'");
                        konek.closekoneksi();
                    } catch (SQLException e) {
                        JOptionPane.showMessageDialog(null, "Error " + e);
                    } catch (ClassNotFoundException ex) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            FrmtransaksiKeluar2 dialog = new FrmtransaksiKeluar2(new javax.swing.JFrame(), true);
