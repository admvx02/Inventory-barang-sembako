 ...
 * @author adam
 */
public class Frmlaporan2 extends javax.swing.JDialog {
    ...
    public Frmlaporan2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
        dateEnabled(false);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Frmlaporan2 dialog = new Frmlaporan2(new javax.swing.JFrame(), true);
