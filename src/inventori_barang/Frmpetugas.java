...
public class Frmpetugas extends javax.swing.JDialog {
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tabelpetugas.id, tabelpetugas.nama, tabelpetugas.username, tabelpetugas.status FROM tabelpetugas");
    ...
    private void GetData_View(){
     ...
     private void cari(){
        try {
            Connection conn = konek.openkoneksi();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet sql = stm.executeQuery("select * from tabelpetugas where nama like '%"+txtcari.getText()+"%'");
            datatable.setModel(DbUtils.resultSetToTableModel(sql));
            datatable.getColumnModel().getColumn(0).setPreferredWidth(35);
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tabelpetugas.id, tabelpetugas.nama, tabelpetugas.username, tabelpetugas.status FROM tabelpetugas WHERE tabelpetugas.id='"+row_id+"'");
                if(sql.next()){
            ...
            if(!"".equals(row_txtnama) && !"".equals(row_txtusername) && !"".equals(row_txtpassword)){
                if (txtpassword.getPassword().length == 0 || txtcpassword.getPassword().length == 0) {
                    ...
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tabelpetugas.id) as count FROM tabelpetugas WHERE tabelpetugas.username='"+row_txtusername+"'");
                        sql.next();
                    ...
                    if("".equals(row_id)){
                        if(c_kode == 0)
                        {
                            try {
                                Connection conn = konek.openkoneksi();
                                java.sql.Statement stm = conn.createStatement();
                                stm.executeUpdate("INSERT INTO tabelpetugas(nama, username, password, status) VALUES ('" + row_txtnama + "', '" + row_txtusername + "', '" + hashed_password + "', '" + row_txtstatus + "')");
                        ...
                        if(c_kode == 0 || row_txtusername.equals(row_txttemp_username))
                        {
                            try {
                                Connection conn = konek.openkoneksi();
                                java.sql.Statement stm = conn.createStatement();
                                stm.executeUpdate("UPDATE tabelpetugas SET nama='" + row_txtnama + "',username='" + row_txtusername + "',password='" + hashed_password + "',status='" + row_txtstatus + "' WHERE id = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tabelpetugas WHERE id = '" + row_id + "'");
